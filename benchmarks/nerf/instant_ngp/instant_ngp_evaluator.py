...
class NGPEvaluator(NeRFEvaluator):
    """Evaluator Class for NGP"""
    ...
    def evaluation(
        ...
        Args:
            ...
            config (ArgsConfig): The evaluation configuration.
            ...
            compute_extra_metrics (bool, optional): Whether to compute extra metrics. Defaults to False.
