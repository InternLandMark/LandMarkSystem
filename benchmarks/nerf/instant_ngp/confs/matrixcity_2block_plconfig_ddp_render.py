...
# flake8: noqa: F405
from benchmarks.nerf.instant_ngp.confs.matrixcity_2block_plconfig_ddp import *
from landmark.nerf_components.configs import RenderConfig

render_config = RenderConfig(
    ckpt="log/matrix_city_blockA_ingp_ddp/state_dict.th",
    kwargs="log/matrix_city_blockA_ingp_ddp/kwargs.th",
    ckpt_type="full",
